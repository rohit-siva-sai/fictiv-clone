      ...
      <div className="flex md:flex-row flex-col md:space-y-0 space-y-12 items-start md:justify-evenly ">
        ...
        <div className="grid grid-cols-2 gap-y-6 md:gap-y-0 md:grid-cols-6 gap-x-8">
          <ul className="text-gray-500 flex flex-col space-y-2 text-xs   "  >
            ...
            <li className="cursor-pointer hover:text-teal-500">3D Printing</li>
            <li className="cursor-pointer hover:text-teal-500">
              Urethane Casting
            </li>
          </ul>
      ...
      <div className="flex md:flex-row flex-col pt-12 justify-center" >
        ...
        <div className=" md:py-0 py-4 flex  space-x-3" >
            ...
            <div className="bg-gray-100 h-fit px-5 py-3 cursor-pointer " >
                <picture  >
                    <img src="https://www.fictiv.com/wp-content/themes/fictiv-theme/assets/images/icons/twitter.svg" alt="" width={20} />
                </picture>
            </div>
            <div className="bg-gray-100 px-5 h-fit py-3 cursor-pointer " >
                <picture  >
                    <img src="https://www.fictiv.com/wp-content/themes/fictiv-theme/assets/images/icons/linkedin.svg" alt="" width={15} />
                </picture>
            </div>
            <div className="bg-gray-100 px-5 h-fit py-3 cursor-pointer " >
                <picture  >
                    <img src="https://www.fictiv.com/wp-content/themes/fictiv-theme/assets/images/icons/youtube.svg" alt="" width={20} />
                </picture>
            </div>
            <div className="bg-gray-100 px-5 h-fit py-3 cursor-pointer " >
                <picture  >
                    <img src="https://www.fictiv.com/wp-content/themes/fictiv-theme/assets/images/icons/tiktok.svg" alt=""  width={15}/>
                </picture>
            </div>
        </div>
      </div>
        <p className="font-bold text-center text-xs" >Copyright © 2023 Fictiv. All rights reserved.</p>
    </div>
  );
};
